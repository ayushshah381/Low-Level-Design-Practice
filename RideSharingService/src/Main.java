public class Main {
    public static void main(String[] args) {
        ...
        // Create passengers
        Passenger passenger1 = new Passenger(1, "Passenger1", "1234567890", new Location(37.7749, -122.4194));
        Passenger passenger2 = new Passenger(2, "Passenger2", "9876543210", new Location(37.7860, -122.4070));
        rideService.addPassenger(passenger1);
        rideService.addPassenger(passenger2);

        // Create drivers
        Driver driver1 = new Driver("4567890123", 1, "Driver1", "ABC123", new Location(37.7749, -122.4194), DriverStatus.AVAILABLE);
        Driver driver2 = new Driver("4567890123",2, "Driver2", "XYZ789", new Location(37.7860, -122.4070), DriverStatus.AVAILABLE);
